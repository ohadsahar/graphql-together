...
function buildCypherSelection(_ref) {
  ...
  if (customCypher) {
    ...
    var translation = (0, _translate.relationFieldOnNodeType)((0, _extends3.default)({}, fieldInfo, {
      schemaType: schemaType,
      selections: selections,
    ...
    var _translation2 = (0, _translate.relationTypeFieldOnNodeType)((0, _extends3.default)({}, fieldInfo, {
      innerSchemaTypeRelation: innerSchemaTypeRelation,
      schemaType: schemaType,
      innerSchemaType: innerSchemaType,
      filterParams: filterParams,
