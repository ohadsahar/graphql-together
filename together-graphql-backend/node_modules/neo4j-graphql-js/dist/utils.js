...
var computeOrderBy = exports.computeOrderBy = function computeOrderBy(resolveInfo, schemaType) {
  ...
  var orderByStatments = orderByArray.map(function (orderByVar) {
    ...
    var hasNoCypherDirective = _lodash2.default.isEmpty(cypherDirective(schemaType, orderBy));
    optimization.earlyOrderBy = optimization.earlyOrderBy && hasNoCypherDirective;
    orderByStatements.push(orderByStatement(resolveInfo, { orderBy: orderBy, order: order }));
  });
...
var possiblySetFirstId = exports.possiblySetFirstId = function possiblySetFirstId(_ref10) {
...
// TODO refactor
var buildCypherParameters = exports.buildCypherParameters = function buildCypherParameters(_ref11) {
...
var getRelationTypeDirective = exports.getRelationTypeDirective = function getRelationTypeDirective(relationshipType) {
...
var decideNestedVariableName = exports.decideNestedVariableName = function decideNestedVariableName(_ref13) {
...
var initializeMutationParams = exports.initializeMutationParams = function initializeMutationParams(_ref14) {
...
var filterNullParams = exports.filterNullParams = function filterNullParams(_ref15) {
  var offset = _ref15.offset,
      first = _ref15.first,
      otherParams = _ref15.otherParams;

  return (0, _entries2.default)((0, _extends3.default)({ offset: offset, first: first }, otherParams)).reduce(function (_ref16, _ref17) {
...
var decideTemporalConstructor = exports.decideTemporalConstructor = function decideTemporalConstructor(typeName) {
  switch (typeName) {
